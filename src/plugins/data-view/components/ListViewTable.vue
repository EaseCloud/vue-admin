...
export default {
  ...
  methods: {
    ...
    renderCell (type, value, index, h, field) {
      ...
      if (type === 'label' || type === 'text') {
        return h(tableComponents.TableFieldText, {props: {value, field, item}})
      } else if (type === 'html') {
        return h(tableComponents.TableFieldHtml, {props: {value, field, item}})
      } else if (type === 'tag') {
        // TODO: 尚未实现
        ...
        return h(tableComponents.TableFieldImage, {props: {value, field, item}})
        // } else if (type === 'image-text') {
        // TODO: 尚未实现
        // return h('div', `TODO:${type}`)
      } else if (type === 'switch') {
        return h(tableComponents.TableFieldSwitch, {
          props: {value, field, index, vmTable: vm, item}
        })
      } else if (type === 'render') {
